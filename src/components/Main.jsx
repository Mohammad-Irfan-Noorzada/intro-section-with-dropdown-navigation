...
function Main() {
  return (
    <main className="main text-center px-3 py-3 md:text-left xl:px-32 xl:py-[2.9rem] lg:px-20 lg:py-16 md:px-12 md:p-10">
      <div className="wrapper flex justify-around flex-col md:gap-10 md:flex-row ">
        ...
        <div className="content mt-16 md:mt-0 gap-10 sm:mt-24 sm:mx-auto md:mx-0 md:gap-12 xl:pt-[6.5rem] lg:pt-20 md:pt-16 flex flex-col justify-between
          sm:w-[38rem] md:w-[32.8rem] order-1 md:order-none">
          <div className="">
          ...
          <div className="flex flex-wrap md:flex-nowrap items-center justify-center md:justify-start gap-7 xl:gap-7 lg:gap-5 md:gap-4 xl:-mb-2">
